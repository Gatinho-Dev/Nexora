...
// PWA: registra o service worker apenas no navegador. Dentro do Tauri ele é
// desnecessário e pode servir assets antigos do cache após uma atualização.
...
// Desktop: remove qualquer service worker/cache deixado por versões antigas.
if (isTauri) {
