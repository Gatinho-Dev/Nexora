  ...
  document.getElementById("root")!.innerHTML = `
    <div style="min-height:100dvh;display:flex;align-items:center;justify-content:center;background:#313338;color:white;font-family:system-ui;padding:20px;text-align:center;">
      <div>
        ...
        <button onclick="window.location.reload()" style="padding:12px 24px;background:#4654D8;color:white;border:none;border-radius:8px;font-weight:bold;cursor:pointer;">Recarregar</button>
      </div>
    </div>
  `;
}
